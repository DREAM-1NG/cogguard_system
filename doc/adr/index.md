...
| 0003 | Semantic Package Governance | [body](0003-semantic-package-governance.md) | partially superseded | ADR 0007 and ADR 0010 supersede affected product and Student choices; semantic package rules remain current. |
...
| 0008 | LAN Prototype Governance Boundary | [body](0008-lan-prototype-governance-boundary.md) | accepted | Accepted local login and single-operator rule, extended by ADR 0009 for durable production governance. |
...
| 0011 | Source-Checkout Distribution | [body](0011-source-checkout-distribution.md) | accepted | Source-checkout deployment is canonical; no standalone backend wheel release. |
| 0012 | Cross-Platform Release Gates | [body](0012-cross-platform-release-gates.md) | accepted | Windows and Ubuntu CI, real migration/integration validation, and required GitHub checks are binding. |
