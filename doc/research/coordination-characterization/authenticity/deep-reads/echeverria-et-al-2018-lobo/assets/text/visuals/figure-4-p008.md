...
- **Suggested region:** [303.795, 238.055, 570.98, 428.814]

## Caption

Figure 4: Error range for mean (blue shade) and classiﬁer accuracy against number of samples seen (for speciﬁc classes)
       ...
       20
        ...
        0
          0      2      4      8     16     32     64    128    256
                               Samples
Figure 4: Error range for mean (blue shade) and classiﬁer accuracy
against number of samples seen (for speciﬁc classes)
~~~
