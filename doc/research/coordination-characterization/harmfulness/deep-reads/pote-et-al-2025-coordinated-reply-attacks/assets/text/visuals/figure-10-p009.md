...
- **Suggested region:** [309.5, 230.297, 568.015, 419.841]

## Caption

Figure 10: (A) Distributions of cosine similarity attributes for replies by IO and normal repliers. (B) Similarity distri- butions for normal repliers (blue, same as in panel (A)) and the 10 different samples (different colored outlines).

## Text from suggested visual region

~~~text
Figure 10: (A) Distributions of cosine similarity attributes
for replies by IO and normal repliers. (B) Similarity distri-
