...
TGN-attn      98.46 ± 0.1   97.81 ± 0.1   98.70 ± 0.1   97.55 ± 0.1   94.52 ± 0.5   91.37 ± 1.1
  ...
  TGAT (Xu et al., 2020)) as well as state-of-the-art models for static graphs (GAE (Kipf & Welling,
   ...
   by a large margin in both transductive and induc-
    tive settings on all datasets. The gap is particularly                                                                  Wikipedia    Reddit
    large on the Twitter dataset, where we outperfom
    the second-best method (DyRep) by over 4% and   GAE∗         74.85 ± 0.6   58.39 ± 0.5
  10% in the transductive and inductive case respec-  VAGE∗        73.67 ± 0.8   57.98 ± 0.6
    tively. Table 3 shows the results on dynamic node   GAT∗          82.34 ± 0.8   64.52 ± 0.5
    classiﬁcation, where again our model obtains state-   GraphSAGE∗   82.42 ± 0.7   61.24 ± 0.6
    of-the-art results, with a large improvement over all  CTDNE       75.89 ± 0.5   59.43 ± 0.6
    other methods.                             JODIE         84.84 ± 1.2   61.83 ± 2.7
                                     TGAT         83.69 ± 0.7   65.56 ± 0.7
  D e to the efﬁcient parallel processing and the need
~~~
