...
- 项目：CogGuard Risk Review 风险研判文档修订
- 当前任务：重写 `aris/tech-03-risk/REVIEW_LAYERED_REQUIREMENTS.md`
- 任务目标：
  - 弱化“特征工程式”叙述
  - 系统扩充高水平参考文献
  - 基于参考文献补充帖子级、用户级、社区级的问题分析与方法设计
  - 保持与当前 `system/backend` 实现边界一致
- 主要输入：
  ...
  - Mannocci 等 2024 综述
- 交付物：
  - 修订后的 `REVIEW_LAYERED_REQUIREMENTS.md`
  - 文献与论证支撑工件（`plan/`）
