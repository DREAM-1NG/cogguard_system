# Risk Review Post-Level Multi-View Harmfulness Formalization

## Target

本文档形式化 Risk Review 帖子级 harmfulness 研判任务：对一条 post 分别构造 `tweet / meme / img / video` 四类 Post View，由四个 View Detector 独立判定，再通过多数投票和加权融合得到帖子级最终结论。
