        ...
        result.update(
            {
                ...
                "model_status": "unavailable",
                "note": f"KT2 event checkpoint not found inside system boundary: {checkpoint}",
            }
        )
        return result
        ...
        result.update(
            {
                "status": "data_insufficient",
                "model_status": "unavailable",
                "note": "KT2 event checkpoint exists, but the event bundle is data-insufficient.",
            }
        )
        return result
    ...
    result.update(
        {
            ...
            "model_status": "unavailable",
            "note": "KT2 event checkpoint exists, but the internal deployed model runtime is not wired yet.",
        }
    )
    return result
