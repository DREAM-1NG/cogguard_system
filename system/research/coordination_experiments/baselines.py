...
def default_baseline_registry() -> BaselineRegistry:
    specs = [
        ...
        BaselineSpec(
            ...
            "deep-len-mlp-fused-detector-v1",
            "detection",
            "learned_comparison",
            "deep-len-mlp-fused-implementation-v1",
            ("binary_coordination_detection", "external_label_evaluation"),
            ("sklearn",),
            warning="Research-only LEN lightweight MLP fused detector for graph-label proxy evaluation.",
            claimable=False,
        ),
        BaselineSpec(
            "deep_len_fast_mlp_fused_detector",
            "deep-len-fast-mlp-fused-detector-v1",
            "detection",
            "learned_comparison",
            "deep-len-fast-mlp-fused-implementation-v1",
            ("binary_coordination_detection", "external_label_evaluation"),
            ("sklearn",),
            warning="Research-only LEN single-configuration fast MLP fused detector for graph-label proxy evaluation.",
            claimable=False,
        ),
        BaselineSpec(
