"""Compatibility wrapper for system/research/propagation_analysis benchmark loaders."""
...
_TARGET = _Path(__file__).resolve().parent / "../../propagation_analysis/benchmark/loaders.py"
