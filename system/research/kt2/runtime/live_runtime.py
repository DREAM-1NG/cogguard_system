"""Compatibility wrapper for system/research/propagation_analysis live runtime."""
...
_TARGET = _Path(__file__).resolve().parent / "../../propagation_analysis/runtime/live_runtime.py"
