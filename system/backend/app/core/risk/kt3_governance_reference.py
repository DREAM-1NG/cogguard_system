"""Public platform governance references for KT3 analyst reports.
...
CONFIG_PATH = Path(__file__).resolve().parent / "config" / "kt3_governance_references.json"
...
def build_governance_reference_context(
    ...
    *,
    ...
    return {
        "schema_version": "kt3-governance-reference-context-v1",
...
def build_governance_report_sidecar(
    *,
    ...
    return {
        "schema_version": "kt3-governance-report-sidecar-v1",
