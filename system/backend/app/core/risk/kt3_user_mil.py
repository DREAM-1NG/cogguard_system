"""KT3 user-level attention-MIL harmfulness scaffold.
...
deterministic inference scaffold over KT3 post-level semantic outputs, not a
    ...
    *,
    ...
    return {
        "capability_boundary": {
            ...
            "description": (
                "Accounts are represented as bags of KT3 post-level semantic "
