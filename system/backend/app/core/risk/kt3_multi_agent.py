...
class KT3AgentProvider(Protocol):
    """Optional offline/test provider hook for one local KT3 agent role."""
...
def execute_kt3_multi_agent_review(
    *,
    ...
    agent_provider: KT3AgentProvider | None = None,
) -> dict[str, Any]:
    """Execute a deterministic multi-agent KT3 review over in-report evidence."""
    ...
    return {
        "capability_boundary": {
            ...
            "description": (
                "Executes distinct KT3 agent roles over a shared in-report "
...
def _build_blackboard(
    *,
    ...
    return {
        ...
        "claims": _as_list(_get(kt3_harmfulness, "global_summary", "claim_rank")),
...
def _apply_provider(
    ...
    blackboard: dict[str, Any],
    local_result: dict[str, Any],
    agent_provider: KT3AgentProvider | None,
