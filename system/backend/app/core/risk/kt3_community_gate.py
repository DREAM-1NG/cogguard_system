"""KT3 community-level evaluation gate.
...
def evaluate_kt3_community_gate(
    *,
    ...
    """Evaluate community-level KT3 outputs against fixed gold labels."""
    community_rows = communities
    if community_rows is None:
        community_rows = _as_list(_get(kt3_harmfulness, "community_level", "communities"))
    effective_graph_export = graph_export
    if effective_graph_export is None:
        maybe_graph_export = _get(kt3_harmfulness, "graph_export")
    ...
    return {
        "capability_boundary": {
            ...
            "description": (
                "Evaluates existing KT3 community-level runtime aggregation on fixed labelled "
        ...
        "summary": {
            ...
            "evaluated_from": "kt3_harmfulness.community_level.communities",
        },
        ...
        agent_tasks.append(
            {
                ...
                "execution_status": "planned_only",
                "requires_external_execution": True,
                "objective": "Review KT3 Community Gate failures without training a graph encoder.",
