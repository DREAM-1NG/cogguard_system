"""KT3 Gate labelled dataset contract.
...
DATASET_CONTRACT_VERSION = "kt3-gate-dataset-v1"
...
GATE_DATASET_USAGE_POLICY = {
    ...
    "description": (
        "KT3 Gate Dataset is an explicit labelled gold/control contract for offline "
...
KT3_GATE_DATASET_CONTRACT = {
    "contract_version": DATASET_CONTRACT_VERSION,
    "artifact_type": "kt3_gate_dataset_contract",
    "purpose": "Explicit gold/control set contract for KT3 Post/User/Community Gate Suite.",
    "request_field": "kt3_gate_dataset",
    "entrypoints": {
        "evaluate": "POST /api/v1/risk/kt3/gate-suite",
        "contract": "GET /api/v1/risk/kt3/gate-dataset/contract",
        "validate": "POST /api/v1/risk/kt3/gate-dataset/validate",
    },
    ...
    "manifest_policy": {
        "artifact_type": "kt3_gate_dataset_manifest",
    ...
    "readiness_policy": {
        ...
        "formal_acceptance_ready": (
            "All three KT3 layers are covered and the dataset declares control "
    ...
    "validation_warning_codes": {
        ...
        "readiness_missing_full_layer_coverage": "Formal KT3 acceptance needs post, user, and community layer gold coverage.",
        "readiness_contract_warnings_present": "Formal KT3 acceptance is blocked while contract-shape warnings remain.",
    ...
    "example_skeleton": {
        ...
        "metadata": {
            ...
            "label_version": "kt3-harm-taxonomy-v1",
...
def get_kt3_gate_dataset_contract_spec() -> dict[str, Any]:
    """Return the machine-readable KT3 Gate Dataset contract."""
    return deepcopy(KT3_GATE_DATASET_CONTRACT)


def normalize_kt3_gate_dataset(dataset: dict[str, Any] | None) -> dict[str, Any]:
    """Normalize an optional KT3 Gate dataset into Suite-ready inputs.
...
def build_kt3_gate_dataset_manifest(normalized: dict[str, Any]) -> dict[str, Any]:
...
def validate_kt3_gate_dataset_contract(dataset: dict[str, Any] | None) -> dict[str, Any]:
