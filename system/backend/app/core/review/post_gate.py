"""Review post-level evaluation gate.
...
def evaluate_post_gate(
    ...
    *,
    ...
    """Evaluate post-level Review outputs against fixed gold cases.
    ...
    return {
        "capability_boundary": {
            ...
            "description": (
                "Evaluates existing Review post semantic outputs on fixed labelled cases. "
        ...
        agent_tasks.append(
            {
                ...
                "execution_status": "planned_only",
                "requires_external_execution": True,
                "objective": "Review Post Gate failures without changing the underlying scorer.",
