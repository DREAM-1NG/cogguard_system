"""Review user-level evaluation gate.
...
def evaluate_user_gate(
    *,
    ...
    """Evaluate account-level Review outputs against fixed gold labels."""
    account_rows = accounts if accounts is not None else _as_list(_get(review_harmfulness, "user_level", "accounts"))
    account_index = {
    ...
    return {
        "capability_boundary": {
            ...
            "description": (
                "Evaluates existing Review user-level runtime aggregation on fixed labelled accounts. "
        ...
        "summary": {
            ...
            "evaluated_from": "review_harmfulness.user_level.accounts",
        },
        ...
        agent_tasks.append(
            {
                ...
                "execution_status": "planned_only",
                "requires_external_execution": True,
                "objective": "Review User Gate failures without training a user encoder.",
