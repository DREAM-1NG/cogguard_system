"""Active evidence retrieval for analyst-triggered Review agent reviews.
...
def build_light_debate_trace(
    *,
    ...
    return {
        "schema_version": "review-light-debate-v1",
...
async def build_full_debate_trace(
    *,
    ...
    if not reasons:
        return {
            "schema_version": "review-full-debate-v1",
    ...
    for stage in stages:
        ...
        system_prompt = (
            "You are a Review debate participant for analyst-triggered harmfulness review. "
