...
THREAD_CONTEXT_SCHEMA = "review-thread-context-v1"
PROPAGATION_CONTEXT_SCHEMA = "review-propagation-context-v1"
...
def _stance_proxy(text: str) -> str:
    lowered = text.lower()
    deny_markers = ("fake", "false", "hoax", "lie", "wrong", "not true", "鍋囩殑", "璋ｈ█", "涓嶅疄", "杈熻埃")
    support_markers = ("true", "confirmed", "agree", "yes", "support", "璇佸疄", "鍚屾剰", "灞炲疄")
