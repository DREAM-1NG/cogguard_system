...
from app.core.analysis.kt1 import analyze_kt1_snapshot, build_kt1_evidence_edges
...
def test_kt1_evidence_builder_covers_multiple_object_types():
    snapshot = _snapshot()

    result = build_kt1_evidence_edges(snapshot, {"min_participation": 1})
...
def test_kt1_analysis_uses_overlapping_windows_and_reports_lineage_significance():
    snapshot = _snapshot()

    result = analyze_kt1_snapshot(
        snapshot,
        {
            "time_window": 3600,
            "min_participation": 1,
