"""Run offline KT3 evidence-validation over kt3-post-case-v1 datasets.
...
def main() -> int:
    ...
    parser.add_argument("--output-dir", default=r"G:\CISCN\tmp\kt3_offline_validation_20260703\evidence_validation")
    ...
    report: dict[str, Any] = {
        "schema": "kt3-offline-evidence-validation-v1",
