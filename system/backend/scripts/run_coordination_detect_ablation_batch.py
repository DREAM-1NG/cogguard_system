...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run CoordinationDiscover Detect ablations on IOHunter processed datasets.")
...
def _write_outputs(output_dir: Path, rows: list[dict[str, object]]) -> dict[str, object]:
    output_dir.mkdir(parents=True, exist_ok=True)
    csv_path = output_dir / "coordination_discover_detect_ablation_all.csv"
    if rows:
    ...
    mean_std_path = output_dir / "coordination_discover_detect_ablation_mean_std.csv"
