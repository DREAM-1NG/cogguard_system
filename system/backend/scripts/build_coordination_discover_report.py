...
ENCODER_LABELS = {
    "magnn_legacy": "MAGNN-Legacy (stable)",
    "magnn": "MAGNN (deprecated)",
    "han": "HAN",
    "amdn_hage": "AMDN-HAGE",
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build CoordinationDiscover Discover report tables and figures.")
    parser.add_argument(
        "--batch-dirs",
        nargs="+",
        required=True,
...
def _write_markdown_report(
    ...
    *,
    ...
    lines: list[str] = []
    lines.append("# CoordinationDiscover Discover Multi-Dataset Report")
    lines.append("")
    lines.append("## Mainline Metrics (MAGNN-Legacy + Leiden)")
    lines.append("")
    lines.append(
        mainline_df[
            [
