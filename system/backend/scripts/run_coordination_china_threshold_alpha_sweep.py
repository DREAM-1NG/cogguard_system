...
DEFAULT_DISCOVERY_PATH = (
    BACKEND_ROOT
    / "experiments"
    / "coordination_discover_io_reproduction"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run threshold × reweight-ratio continuous sweep on China CoordinationDiscover Detect.")
