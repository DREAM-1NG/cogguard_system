...
EXPERIMENT_ROOT = BACKEND_ROOT / "experiments" / "kt1_io_reproduction"
DEFAULT_ARCHIVE_NAME = "archive_kt1_final_20260628"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Archive KT1 Discover/Detect experiment outputs into a reusable bundle.")
    parser.add_argument(
        "--archive-dir",
...
def _write_markdown(
    ...
    *,
    ...
    lines = [
        f"# {archive_name}",
        "",
        "This archive bundles the stable KT1 Discover/Detect experiment outputs for later reuse.",
        "",
