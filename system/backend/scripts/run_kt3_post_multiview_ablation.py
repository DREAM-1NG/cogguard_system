"""Run KT3 post-level multiview ablations across available kt3-post-case datasets.
...
from run_kt3_multioff_multiview_ablation import (
    LABELS,
    compute_metrics,
    image_path_of,
    label_of,
...
def main() -> int:
    ...
    parser.add_argument("--output-dir", default=r"G:\CISCN\.tmp\kt3_post_multiview_ablation")
    ...
    parser.add_argument(
        "--fakesv-c3d-zip",
        default=r"G:\CISCN\dataset\kt3_public\FakeSV\features\c3d.zip",
    ...
    report = {
        "schema": "kt3-post-multiview-ablation-suite-v1",
...
def summarize_suite(datasets: dict[str, dict[str, Any]]) -> dict[str, Any]:
    ...
    return {
        ...
        "note": (
            "This suite evaluates currently available local kt3-post-case views. "
