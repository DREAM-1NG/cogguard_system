"""Run a text-only baseline on kt3-post-case-v1 JSONL files.
...
def main() -> int:
    ...
    parser.add_argument("--output-dir", default=r"G:\CISCN\.tmp\kt3_post_text_baseline")
    parser.add_argument(
        "--datasets",
        nargs="*",
    ...
    report = {
        "schema": "kt3-post-text-baseline-report-v1",
        ...
        "capability_boundary": {
            ...
            "description": (
                "This baseline uses only kt3-post-case text and harmfulness labels. "
