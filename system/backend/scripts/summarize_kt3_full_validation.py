"""Summarize KT3 post-level full-validation readiness.
...
def main() -> int:
    ...
    parser.add_argument("--audit", default=r"G:\CISCN\.tmp\kt3_post_dataset_audit_v2.json")
    parser.add_argument("--manifest", default=r"G:\CISCN\.tmp\kt3_post_cases_full\manifest.json")
    parser.add_argument("--suite", default=r"G:\CISCN\.tmp\kt3_post_multiview_ablation_full_registry\report.json")
    parser.add_argument("--output", default=r"G:\CISCN\.tmp\kt3_full_validation_gate_report.json")
...
def build_gate_report(
    ...
    return {
        "schema": "kt3-full-validation-gate-v1",
        "inputs": {
