"""Prepare KT3 optional model and RAG assets.

Downloads go to durable project asset folders by default:

- HuggingFace models: G:\\CISCN\\hf_models
- Public DISARM RAG files: G:\\CISCN\\dataset\\kt3_public\\DISARM_RAG
...
def main() -> int:
    ...
    parser.add_argument("--rag-dir", default=r"G:\CISCN\dataset\kt3_public\DISARM_RAG")
    ...
    summary: dict[str, Any] = {
        ...
        "manual_assets": {
            "FakeSV raw videos": {
                ...
                "reason": "current KT3 pipeline uses public pre-extracted C3D features; raw video files are not bundled in the prepared local data",
                "links": [
...
def fetch_url(url: str) -> bytes:
    request = Request(url, headers={"User-Agent": "CogGuard-KT3-asset-prep/1.0"})
