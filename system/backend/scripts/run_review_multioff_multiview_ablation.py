"""Run MultiOFF text/image/fusion ablations for Review post-level MV-PostGuard.
...
def main() -> int:
    ...
    parser.add_argument("--output-dir", default=r"G:\CISCN\.tmp\review_multioff_multiview_ablation")
...
def evaluate_multioff(
    ...
    *,
    ...
    report: dict[str, Any] = {
        "schema": "review-multioff-multiview-ablation-report-v1",
        "dataset": dataset,
...
def summarize(experiments: dict[str, dict[str, Any]]) -> dict[str, Any]:
    ...
    return {
        ...
        "note": (
            ...
            "not full MV-PostGuard validation across all Review datasets and views."
        ),
    }
