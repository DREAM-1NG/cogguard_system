...
- **Suggested region:** [35.945, 80.791, 449.906, 450.722]

## Caption

Table 1. A Review of Frequently Used Model Evaluation Metrics
...
- [PDF p.8] The choice of a metric is often subjective, even under a well-defined problem formulation. Pre- vious works found that a model might perform well in one metric but significantly drop in an- other [72], making it difficult to do a fair comparison between various approaches. We summarize frequently used metrics as well as their adopters in Table 1.
